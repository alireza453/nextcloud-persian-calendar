...
const router = new Router({
	...
	routes: [
		...
		},
		{
			...
			redirect: (to) =>
				`/${
					to.params.view ?? getInitialView()
				}/now/new/${getPreferredEditorRoute()}/0/${getDefaultStartDateForNewEvent()}/${getDefaultEndDateForNewEvent()}`,
		},
		{
			path: "/new/:allDay/:dtstart/:dtend",
			redirect: () =>
				`/${getInitialView()}/:dtstart/new/${getPreferredEditorRoute()}/:allDay/:dtstart/:dtend`,
		},
		{
			path: "/edit/:object",
			redirect: () =>
				`/${getInitialView()}/now/edit/${getPreferredEditorRoute()}/:object/next`,
		},
		{
			path: "/edit/:object/:recurrenceId",
			redirect: () =>
				`/${getInitialView()}/now/edit/${getPreferredEditorRoute()}/:object/:recurrenceId`,
		},
		/**
