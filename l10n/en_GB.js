OC.L10N.register(
	"calendar",
	{
		...
		"Hello,": "Hello,",
		"We wanted to inform you that %s has published the calendar »%s«.":
			"We wanted to inform you that %s has published the calendar »%s«.",
		"Open »%s«": "Open »%s«",
		"Cheers!": "Cheers!",
		...
		'{display_name} ({email}) booked the appointment "{config_display_name}" on {date_time}.':
			'{display_name} ({email}) booked the appointment "{config_display_name}" on {date_time}.',
		...
		'Your appointment "%s" with %s needs confirmation':
			'Your appointment "%s" with %s needs confirmation',
		"Dear %s, please confirm your booking":
			"Dear %s, please confirm your booking",
		Confirm: "Confirm",
		"This confirmation link expires in %s hours.":
			"This confirmation link expires in %s hours.",
		"If you wish to cancel the appointment after all, please contact your organizer by replying to this email or by visiting their profile page.":
			"If you wish to cancel the appointment after all, please contact your organiser by replying to this email or by visiting their profile page.",
		'Your appointment "%s" with %s has been accepted':
			'Your appointment "%s" with %s has been accepted',
		"Dear %s, your booking has been accepted.":
			"Dear %s, your booking has been accepted.",
		"Appointment for:": "Appointment for:",
		"Date:": "Date:",
		"You will receive a link with the confirmation email":
			"You will receive a link with the confirmation email",
		"Where:": "Where:",
		"Comment:": "Comment:",
		'You have a new appointment booking "%s" from %s':
			'You have a new appointment booking "%s" from %s',
		"Dear %s, %s (%s) booked an appointment with you.":
			"Dear %s, %s (%s) booked an appointment with you.",
		...
		Edit: "Edit",
		Delete: "Delete",
		"Appointment link was copied to clipboard":
			"Appointment link was copied to clipboard",
		"Appointment link could not be copied to clipboard":
			"Appointment link could not be copied to clipboard",
		"Add new": "Add new",
		...
		"An error occurred, unable to change visibility of the calendar.":
			"An error occurred, unable to change visibility of the calendar.",
		"_Unsharing the calendar in {countdown} second_::_Unsharing the calendar in {countdown} seconds_":
			[
				"Unsharing the calendar in {countdown} second",
				"Unsharing the calendar in {countdown} seconds",
			],
		"_Deleting the calendar in {countdown} second_::_Deleting the calendar in {countdown} seconds_":
			[
		...
		"Calendar link could not be copied to clipboard.":
			"Calendar link could not be copied to clipboard.",
		"Trash bin": "Trash bin",
		...
		"Could not load deleted calendars and objects":
			"Could not load deleted calendars and objects",
		"Could not restore calendar or event":
			"Could not restore calendar or event",
		"Do you really want to empty the trash bin?":
			"Do you really want to empty the trash bin?",
		"_Items in the trash bin are deleted after {numDays} day_::_Items in the trash bin are deleted after {numDays} days_":
			[
		...
		"A private link that can be used with external clients":
			"A private link that can be used with external clients",
		...
		"An error occurred, unable to publish calendar.":
			"An error occurred, unable to publish calendar.",
		"An error occurred, unable to send email.":
			"An error occurred, unable to send email.",
		"Embed code copied to clipboard.": "Embed code copied to clipboard.",
		"Embed code could not be copied to clipboard.":
			"Embed code could not be copied to clipboard.",
		...
		Save: "Save",
		"Failed to save calendar name and color":
			"Failed to save calendar name and colour",
		"Import calendars": "Import calendars",
		"Please select a calendar to import into …":
			"Please select a calendar to import into …",
		Filename: "Filename",
		"Calendar to import into": "Calendar to import into",
		Cancel: "Cancel",
		"_Import calendar_::_Import calendars_": [
			"Import calendar",
			"Import calendars",
		],
		"Default attachments location": "Default attachments location",
		"Select the default location for attachments":
			"Select the default location for attachments",
		"Invalid location selected": "Invalid location selected",
		"Attachments folder successfully saved.":
			"Attachments folder successfully saved.",
		"Error on saving attachments folder.":
			"Error on saving attachments folder.",
		"{filename} could not be parsed": "{filename} could not be parsed",
		"No valid files found, aborting import":
			"No valid files found, aborting import",
		"Import partially failed. Imported {accepted} out of {total}.":
			"Import partially failed. Imported {accepted} out of {total}.",
		"_Successfully imported %n event_::_Successfully imported %n events_": [
			"Successfully imported %n event",
			"Successfully imported %n events",
		],
		Automatic: "Automatic",
		"Automatic ({detected})": "Automatic ({detected})",
		"New setting was not saved successfully.":
			"New setting was not saved successfully.",
		...
		"Limit the number of events displayed in the monthly view":
			"Limit the number of events displayed in the monthly view",
		"Show weekends": "Show weekends",
		"Show week numbers": "Show week numbers",
		"Time increments": "Time increments",
		"Default calendar for invitations and new events":
			"Default calendar for invitations and new events",
		...
		"CalDAV link could not be copied to clipboard.":
			"CalDAV link could not be copied to clipboard.",
		"Appointment was created successfully":
			"Appointment was created successfully",
		"Appointment was updated successfully":
			"Appointment was updated successfully",
		"_{duration} minute_::_{duration} minutes_": [
			"{duration} minute",
			"{duration} minutes",
		],
		"0 minutes": "0 minutes",
		"_{duration} hour_::_{duration} hours_": [
			"{duration} hour",
			"{duration} hours",
		],
		"_{duration} day_::_{duration} days_": [
			"{duration} day",
			"{duration} days",
		],
		"_{duration} week_::_{duration} weeks_": [
			"{duration} week",
			"{duration} weeks",
		],
		...
		"_{duration} year_::_{duration} years_": [
			"{duration} year",
			"{duration} years",
		],
		"To configure appointments, add your email address in personal settings.":
			"To configure appointments, add your email address in personal settings.",
		"Public – shown on the profile page": "Public – shown on the profile page",
		"Private – only accessible via secret link":
			"Private – only accessible via secret link",
		"Appointment name": "Appointment name",
		Location: "Location",
		"Create a Talk room": "Create a Talk room",
		"A unique link will be generated for every booked appointment and sent via the confirmation email":
			"A unique link will be generated for every booked appointment and sent via the confirmation email",
		Description: "Description",
		Visibility: "Visibility",
		Duration: "Duration",
		Increments: "Increments",
		"Additional calendars to check for conflicts":
			"Additional calendars to check for conflicts",
		"Pick time ranges where appointments are allowed":
			"Pick time ranges where appointments are allowed",
		to: "to",
		...
		Sunday: "Sunday",
		Weekdays: "Weekdays",
		"Add time before and after the event":
			"Add time before and after the event",
		...
		"Limit how far in the future appointments can be booked":
			"Limit how far in the future appointments can be booked",
		"It seems a rate limit has been reached. Please try again later.":
			"It seems a rate limit has been reached. Please try again later.",
		"Create appointment": "Create appointment",
		"Edit appointment": "Edit appointment",
		Update: "Update",
		"Please confirm your reservation": "Please confirm your reservation",
		"We sent you an email with details. Please confirm your appointment using the link in the email. You can close this page now.":
			"We sent you an email with details. Please confirm your appointment using the link in the email. You can close this page now.",
		"Your name": "Your name",
		...
		"Could not book the appointment. Please try again later or contact the organizer.":
			"Could not book the appointment. Please try again later or contact the organiser.",
		...
		"Accepted {organizerName}'s invitation":
			"Accepted {organizerName}'s invitation",
		"Not available": "Not available",
		"Invitation declined": "Invitation declined",
		"Declined {organizerName}'s invitation":
			"Declined {organizerName}'s invitation",
		"Invitation is delegated": "Invitation is delegated",
		"Checking availability": "Checking availability",
		"Awaiting response": "Awaiting response",
		"Has not responded to {organizerName}'s invitation yet":
			"Has not responded to {organizerName}'s invitation yet",
		"Availability of attendees, resources and rooms":
			"Availability of attendees, resources and rooms",
		...
		"Your participation has been marked as tentative.":
			"Your participation has been marked as tentative.",
		"Failed to set the participation status to tentative.":
			"Failed to set the participation status to tentative.",
		Attendees: "Attendees",
		"Create Talk room for this event": "Create Talk room for this event",
		"No attendees yet": "No attendees yet",
		"You do not own this calendar, so you cannot add attendees to this event":
			"You do not own this calendar, so you cannot add attendees to this event",
		"{invitedCount} invited, {confirmedCount} confirmed":
			"{invitedCount} invited, {confirmedCount} confirmed",
		"Successfully appended link to talk room to location.":
			"Successfully appended link to talk room to location.",
		"Successfully appended link to talk room to description.":
			"Successfully appended link to talk room to description.",
		...
		"Search for emails, users, contacts or groups":
			"Search for emails, users, contacts or groups",
		"No match found": "No match found",
		"Note that members of circles get invited but are not synced yet.":
			"Note that members of circles get invited but are not synced yet.",
		"(organizer)": "(organiser)",
		"To send out invitations and handle responses, [linkopen]add your email address in personal settings[linkclose].":
			"To send out invitations and handle responses, [linkopen]add your email address in personal settings[linkclose].",
		...
		"This event is the recurrence-exception of a recurrence-set. You cannot add a recurrence-rule to it.":
			"This event is the recurrence-exception of a recurrence-set. You cannot add a recurrence-rule to it.",
		first: "first",
		third: "third",
		fourth: "fourth",
		...
		last: "last",
		"Changes to the recurrence-rule will only apply to this and all future occurrences.":
			"Changes to the recurrence-rule will only apply to this and all future occurrences.",
		...
		"The recurrence definition of this event is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost.":
			"The recurrence definition of this event is not fully supported by Nextcloud. If you edit the recurrence-options, certain recurrences may be lost.",
		...
		"_{seatingCapacity} seat_::_{seatingCapacity} seats_": [
		...
		"Maybe the share was deleted or has expired?":
			"Maybe the share was deleted or has expired?",
		...
		"No valid public calendars configured":
			"No valid public calendars configured",
		"Speak to the server administrator to resolve this issue.":
			"Speak to the server administrator to resolve this issue.",
		"Public holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}":
			"Public holiday calendars are provided by Thunderbird. Calendar data will be downloaded from {website}",
		"These public calendars are suggested by the sever administrator. Calendar data will be downloaded from the respective website.":
			"These public calendars are suggested by the sever administrator. Calendar data will be downloaded from the respective website.",
		"By {authors}": "By {authors}",
		Subscribed: "Subscribed",
		Subscribe: "Subscribe",
		"Holidays in {region}": "Holidays in {region}",
		"An error occurred, unable to read public calendars.":
			"An error occurred, unable to read public calendars.",
		"An error occurred, unable to subscribe to calendar.":
			"An error occurred, unable to subscribe to calendar.",
		"Select date": "Select date",
		"Select slot": "Select slot",
		"No slots available": "No slots available",
		"Could not fetch slots": "Could not fetch slots",
		"The slot for your appointment has been confirmed":
			"The slot for your appointment has been confirmed",
		"Appointment Details:": "Appointment Details:",
		"Time:": "Time:",
		"Booked for:": "Booked for:",
		"Thank you. Your booking from {startDate} to {endDate} has been confirmed.":
			"Thank you. Your booking from {startDate} to {endDate} has been confirmed.",
		"Book another appointment:": "Book another appointment:",
		"See all available slots": "See all available slots",
		"The slot for your appointment from {startDate} to {endDate} is not available any more.":
			"The slot for your appointment from {startDate} to {endDate} is not available any more.",
		"Please book a different slot:": "Please book a different slot:",
		"Book an appointment with {name}": "Book an appointment with {name}",
		"No public appointments found for {name}":
			"No public appointments found for {name}",
		Personal: "Personal",
		...
		Invite: "Invite",
		Resources: "Resources",
		"_User requires access to your file_::_Users require access to your file_":
			[
				"User requires access to your file",
				"Users require access to your file",
			],
		"_Attachment requires shared access_::_Attachments requiring shared access_":
			[
		...
		Travel: "Travel",
		Vacation: "Vacation",
		"Midnight on the day the event starts":
			"Midnight on the day the event starts",
		"_%n day before the event at {formattedHourMinute}_::_%n days before the event at {formattedHourMinute}_":
			[
				"%n day before the event at {formattedHourMinute}",
				"%n days before the event at {formattedHourMinute}",
			],
		"_%n week before the event at {formattedHourMinute}_::_%n weeks before the event at {formattedHourMinute}_":
			[
		...
		"No events": "No events",
		"Create a new event or change the visible time-range":
			"Create a new event or change the visible time-range",
		...
		"The visibility of this event in shared calendars.":
			"The visibility of this event in shared calendars.",
		...
		Confirmed: "Confirmed",
		Canceled: "Canceled",
		"Confirmation about the overall status of the event.":
			"Confirmation about the overall status of the event.",
		"Show as": "Show as",
		"Take this event into account when calculating free-busy information.":
			"Take this event into account when calculating free-busy information.",
		Categories: "Categories",
		"Categories help you to structure and organize your events.":
			"Categories help you to structure and organize your events.",
		"Search or add categories": "Search or add categories",
		"Add this as a new category": "Add this as a new category",
		"Custom color": "Custom colour",
		"Special color of this event. Overrides the calendar-color.":
			"Special colour of this event. Overrides the calendar-colour.",
		"Error while sharing file": "Error while sharing file",
		"Error while sharing file with user": "Error while sharing file with user",
		"Attachment {fileName} already exists!":
			"Attachment {fileName} already exists!",
		"An error occurred during getting file information":
			"An error occurred during getting file information",
		"Chat room for event": "Chat room for event",
		"An error occurred, unable to delete the calendar.":
			"An error occurred, unable to delete the calendar.",
